    ...
    public class WriterTests {
        ...
        public void TestSerializeDateTime() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                writer.Serialize(date);
                Assert.AreEqual("D20180410;r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
            using (MemoryStream stream = new MemoryStream()) {
                Writer writer = new Writer(stream);
                ...
                writer.Serialize(date);
                writer.Serialize(date);
                Assert.AreEqual("D20180410T133134.567;r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
            using (MemoryStream stream = new MemoryStream()) {
                Writer writer = new Writer(stream);
                ...
                writer.Serialize(date);
                writer.Serialize(date);
                Assert.AreEqual("T133134.567;r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
            using (MemoryStream stream = new MemoryStream()) {
                Writer writer = new Writer(stream);
                ...
                writer.Serialize(date);
                writer.Serialize(date);
                Assert.AreEqual("D00010101T000012.345678900;r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        public void TestSerializeGuid() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                writer.Serialize(Guid.Empty);
                Assert.AreEqual("g{" + Guid.Empty.ToString() + "}r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        public void TestSerializeNullable() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                a = null;
                writer.Serialize(a);
                Assert.AreEqual("1n", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        ...
        public void TestSerializeString() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                writer.Serialize(s);
                writer.Serialize(s);
                Assert.AreEqual("ns5\"hello\"r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
            using (MemoryStream stream = new MemoryStream()) {
                Writer writer = new Writer(stream);
                writer.Serialize("");
                ...
                Assert.AreEqual("euAs5\"hello\"", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        public void TestSerializeBytes() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                writer.Serialize(a);
                writer.Serialize(a);
                Assert.AreEqual("b5\"12345\"r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        public void TestSerializeChars() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                writer.Serialize(a);
                writer.Serialize(a);
                Assert.AreEqual("s5\"12345\"r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        public void TestSerializeArray() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                writer.Serialize(a);
                writer.Serialize(a);
                Assert.AreEqual("a6{n12345}r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
            using (MemoryStream stream = new MemoryStream()) {
                Writer writer = new Writer(stream);
                var a = new object[] {
                ...
                writer.Serialize(a);
                writer.Serialize(a);
                Assert.AreEqual("a7{n12345s5\"hello\"}r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        public void TestSerializeArraySegment() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                Assert.AreEqual("a5{12345}r0;a2{45}", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        ...
        public void TestSerializeDictionary() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                writer.Serialize(dict);
                Assert.AreEqual("m3{n12345}r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
            using (MemoryStream stream = new MemoryStream()) {
                Writer writer = new Writer(stream);
        ...
        public void TestSerializeEnum() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                Assert.AreEqual("36", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        public void TestSerializeValueTuple() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                writer.Serialize(c);
                Assert.AreEqual("a{}a2{1s5\"hello\"}a3{12r2;}a4{123r2;}a5{1234r2;}a6{12345r2;}a7{123456r2;}a8{1234567r2;}r8;a9{12345678r2;}r9;a30{123456789012345678901234567890}", Encoding.UTF8.GetString(stream.ToArray()));
            }
            using (MemoryStream stream = new MemoryStream()) {
                Writer writer = new Writer(stream);
                writer.Serialize(ValueTuple.Create(ValueTuple.Create(), ValueTuple.Create()));
                Assert.AreEqual("a2{a{}r1;}", Encoding.UTF8.GetString(stream.ToArray()));
            }
            using (MemoryStream stream = new MemoryStream()) {
                Writer writer = new Writer(stream);
                ...
                writer.Serialize(a);
                Assert.AreEqual("a8{1234567a{}}", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        public void TestSerializeTuple() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                writer.Serialize(c);
                Assert.AreEqual("a1{1}a2{1s5\"hello\"}a3{12r2;}a4{123r2;}a5{1234r2;}a6{12345r2;}a7{123456r2;}a8{1234567r2;}r8;a9{12345678r2;}r9;a20{12345678901234567890}", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        ...
        public void TestSerializeHashtable() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                writer.Serialize(dict);
                writer.Serialize(dict);
                Assert.AreEqual("m3{4523n1}r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        public void TestSerializeBitArray() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                writer.Serialize(a);
                writer.Serialize(a);
                Assert.AreEqual("a6{tftftf}r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        public void TestSerializeStream() {
            using (MemoryStream stream = new MemoryStream()) {
                using (MemoryStream s = new MemoryStream(new byte[] { (byte)'0', (byte)'1', (byte)'2' })) {
                    ...
                    writer.Serialize(s);
                    writer.Serialize(s);
                    Assert.AreEqual("b3\"012\"r0;", Encoding.UTF8.GetString(stream.ToArray()));
                }
            }
        }
        [TestMethod]
        public void TestSerializeMDArray() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                Assert.AreEqual("a2{a2{a2{12}a2{34}}a2{a2{56}a2{78}}}r0;a2{a2{12}a2{34}}r7;", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        public void TestSerializeAnonymousType() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                writer.Serialize(v);
                writer.Serialize(v);
                Assert.AreEqual("m2{s6\"amount\"i108;s7\"message\"s5\"Hello\"}r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        ...
        public void TestSerializeObject() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                writer.Serialize(o2);
                writer.Serialize(o);
                Assert.AreEqual("c6\"Person\"3{s2\"id\"s4\"name\"s3\"age\"}o0{0s3\"Tom\"i48;}o0{1s5\"Jerry\"i36;}r3;", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
        [TestMethod]
        public void TestSerializeExpandoObject() {
            using (MemoryStream stream = new MemoryStream()) {
                ...
                writer.Serialize(o);
                writer.Serialize(o);
                Assert.AreEqual("m2{s2\"id\"1s4\"name\"s4\"Test\"}r0;", Encoding.UTF8.GetString(stream.ToArray()));
            }
        }
    }
}
