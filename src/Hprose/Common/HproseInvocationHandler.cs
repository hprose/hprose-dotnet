    ...
    class HproseInvocationHandler : IInvocationHandler {
        ...
        public object Invoke(object proxy, MethodInfo method, object[] args) {
            ...
            if ((n > 0) && (paramTypes[n - 1] == typeof(HproseCallback))) {
                ...
                invoker.Invoke(functionName, tmpargs, callback, byRef);
                return null;
            }
            if ((n > 0) && (paramTypes[n - 1] == typeof(HproseCallback1))) {
                ...
                object[] tmpargs = new object[n - 1];
                Array.Copy(args, 0, tmpargs, 0, n - 1);
                invoker.Invoke(functionName, tmpargs, callback);
                return null;
            }
            if ((n > 1) && (paramTypes[n - 2] == typeof(HproseCallback)) &&
                ...
                invoker.Invoke(functionName, tmpargs, callback, returnType, byRef);
                return null;
            }
            if ((n > 1) && (paramTypes[n - 2] == typeof(HproseCallback1)) &&
                ...
                object[] tmpargs = new object[n - 2];
                Array.Copy(args, 0, tmpargs, 0, n - 2);
                invoker.Invoke(functionName, tmpargs, callback, returnType);
                return null;
            }
            ...
            if ((n > 0) && (paramTypes[n - 1].IsGenericType &&
                ...
                object[] tmpargs = new object[n - 1];
                Array.Copy(args, 0, tmpargs, 0, n - 1);
                helper.Invoke(invoker, functionName, tmpargs, callback, byRef);
                return null;
            }
            if ((n > 0) && (paramTypes[n - 1].IsGenericType &&
                ...
                object[] tmpargs = new object[n - 1];
                Array.Copy(args, 0, tmpargs, 0, n - 1);
                helper.Invoke(invoker, functionName, tmpargs, callback);
                return null;
            }
#endif
            object result = invoker.Invoke(functionName, args, returnType, byRef);
