...
internal static class NumericsHelpers {
        ...
        public static int CbitHighZero(ulong uu) => (uu & 18446744069414584320L) == 0L ? 0x20 + CbitHighZero((uint)uu) : CbitHighZero((uint)(uu >> 0x20));
        ...
        public static uint CombineHash(uint u1, uint u2) => (((u1 << 7) | (u1 >> 0x19)) ^ u2);
        ...
        public static double GetDoubleFromParts(int sign, int exp, ulong man) {
            ...
            if (man == 0L) {
                ...
                if (exp >= 0x7ff) {
                    ...
                    @ulong.uu = (man & 0xfffffffffffffL) | (((ulong)exp) << 0x34);
                }
            }
            if (sign < 0) {
        ...
        public static void GetDoubleParts(double dbl, out int sign, out int exp, out ulong man, out bool fFinite) {
            ...
            if (exp == 0) {
                ...
                fFinite = true;
                man = man | 0x10000000000000L;
                exp -= 0x433;
            }
        }
        public static uint GetHi(ulong uu) => (uint)(uu >> 0x20);

        public static uint GetLo(ulong uu) => (uint)uu;

        public static ulong MakeUlong(uint uHi, uint uLo) => ((ulong)uHi << 0x20) | uLo;
