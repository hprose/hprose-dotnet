...
namespace Hprose.Collections.Generic {
    ...
    public sealed class NullableKeyDictionary<TKey, TValue> : Dictionary<NullableKey<TKey>, TValue>,
        ...
        public new sealed class KeyCollection : ICollection<TKey>,
            ...
            [NonSerialized]
            private readonly Dictionary<NullableKey<TKey>, TValue> _dictionary;
            [NonSerialized]
            private readonly Dictionary<NullableKey<TKey>, TValue>.KeyCollection _keyCollection;
            ...
            public struct Enumerator : IEnumerator<TKey>, IDisposable, IEnumerator {
                private readonly IEnumerator<NullableKey<TKey>> _enumerator;
