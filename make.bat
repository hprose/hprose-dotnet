...
if not exist dist\Hprose\Release\net462 mkdir dist\Hprose\Release\net462
if not exist dist\Hprose\Release\net47 mkdir dist\Hprose\Release\net47
...
if not exist dist\Hprose\Release\xamarinmac mkdir dist\Hprose\Release\xamarinmac
...
if not exist dist\Hprose\Debug\net462 mkdir dist\Hprose\Debug\net462
if not exist dist\Hprose\Debug\net47 mkdir dist\Hprose\Debug\net47
...
if not exist dist\Hprose\Debug\xamarinmac mkdir dist\Hprose\Debug\xamarinmac
...
if not exist dist\Hprose.Client\Release\net461 mkdir dist\Hprose.Client\Release\net461
if not exist dist\Hprose.Client\Release\net462 mkdir dist\Hprose.Client\Release\net462
if not exist dist\Hprose.Client\Release\net47 mkdir dist\Hprose.Client\Release\net47
...
if not exist dist\Hprose.Client\Release\xamarinmac mkdir dist\Hprose.Client\Release\xamarinmac
...
if not exist dist\Hprose.Client\Debug\net461 mkdir dist\Hprose.Client\Debug\net461
if not exist dist\Hprose.Client\Debug\net462 mkdir dist\Hprose.Client\Debug\net462
if not exist dist\Hprose.Client\Debug\net47 mkdir dist\Hprose.Client\Debug\net47
...
if not exist dist\Hprose.Client\Debug\xamarinmac mkdir dist\Hprose.Client\Debug\xamarinmac
...
set ROSLYN_PATH=%PRO_PATH%\Microsoft Visual Studio\2017\Community\MSBuild\15.0\Bin\Roslyn
set XAMARIN_PATH=%PRO_PATH%\Microsoft Visual Studio\2017\Community\Common7\IDE\ReferenceAssemblies\Microsoft\Framework
...
echo start compile hprose for .NET 4.6.1 Release
set DOTNET_PATH=%PRO_PATH%\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1
set DOTNET_REFERENCE=
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\mscorlib.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Core.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Runtime.Serialization.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Numerics.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose.Client\Release\net461\Hprose.Client.dll -define:dotNET4;dotNET45;dotNET451;dotNET452;dotNET46;dotNET461;ClientOnly -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Web.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose\Release\net461\Hprose.dll -define:dotNET4;dotNET45;dotNET451;dotNET452;dotNET46;dotNET461 -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%

echo start compile hprose for .NET 4.6.1 Debug
set DOTNET_PATH=%PRO_PATH%\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.1
set DOTNET_REFERENCE=
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\mscorlib.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Core.dll"
...
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Runtime.Serialization.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Numerics.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose.Client\Debug\net461\Hprose.Client.dll -define:dotNET4;dotNET45;dotNET451;dotNET452;dotNET46;dotNET461;ClientOnly -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ -debug+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Web.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose\Debug\net461\Hprose.dll -define:dotNET4;dotNET45;dotNET451;dotNET452;dotNET46;dotNET461 -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ -debug+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%

echo start compile hprose for .NET 4.6.2 Release
set DOTNET_PATH=%PRO_PATH%\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.2
set DOTNET_REFERENCE=
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\mscorlib.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Core.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Runtime.Serialization.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Numerics.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose.Client\Release\net462\Hprose.Client.dll -define:dotNET4;dotNET45;dotNET451;dotNET452;dotNET46;dotNET461;dotNET462;ClientOnly -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Web.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose\Release\net462\Hprose.dll -define:dotNET4;dotNET45;dotNET451;dotNET452;dotNET46;dotNET461;dotNET462 -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%

echo start compile hprose for .NET 4.6.2 Debug
set DOTNET_PATH=%PRO_PATH%\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.6.2
set DOTNET_REFERENCE=
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\mscorlib.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Core.dll"
...
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Runtime.Serialization.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Numerics.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose.Client\Debug\net462\Hprose.Client.dll -define:dotNET4;dotNET45;dotNET451;dotNET452;dotNET46;dotNET461;dotNET462;ClientOnly -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ -debug+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Web.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose\Debug\net462\Hprose.dll -define:dotNET4;dotNET45;dotNET451;dotNET452;dotNET46;dotNET461;dotNET462 -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ -debug+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%

echo start compile hprose for .NET 4.7 Release
set DOTNET_PATH=%PRO_PATH%\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.7
set DOTNET_REFERENCE=
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\mscorlib.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Core.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Runtime.Serialization.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Numerics.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose.Client\Release\net47\Hprose.Client.dll -define:dotNET4;dotNET45;dotNET451;dotNET452;dotNET46;dotNET461;dotNET462;dotNET47;ClientOnly -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Web.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose\Release\net47\Hprose.dll -define:dotNET4;dotNET45;dotNET451;dotNET452;dotNET46;dotNET461;dotNET462;dotNET47 -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%

echo start compile hprose for .NET 4.7 Debug
set DOTNET_PATH=%PRO_PATH%\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.7
set DOTNET_REFERENCE=
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\mscorlib.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Core.dll"
...
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Runtime.Serialization.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Numerics.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose.Client\Debug\net47\Hprose.Client.dll -define:dotNET4;dotNET45;dotNET451;dotNET452;dotNET46;dotNET461;dotNET462;dotNET47;ClientOnly -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ -debug+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Web.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose\Debug\net47\Hprose.dll -define:dotNET4;dotNET45;dotNET451;dotNET452;dotNET46;dotNET461;dotNET462;dotNET47 -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ -debug+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%

echo start compile hprose for MonoAndroid Release
set DOTNET_PATH=%XAMARIN_PATH%\MonoAndroid\v1.0
set DOTNET_REFERENCE=
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\mscorlib.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Core.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.dll"
...
set DOTNET_PATH=%XAMARIN_PATH%\MonoTouch\v1.0
set DOTNET_REFERENCE=
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\mscorlib.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Core.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.dll"
...
echo start compile hprose for Xamarin.Mac Release
set DOTNET_PATH=%XAMARIN_PATH%\Xamarin.Mac\v2.0
set DOTNET_REFERENCE=
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\mscorlib.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Core.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Runtime.Serialization.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Numerics.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose.Client\Release\xamarinmac\Hprose.Client.dll -define:dotNET4;dotNET45;MONO;Unity;ClientProfile;ClientOnly -filealign:512 -target:library -noconfig -nowarn:1685 -nostdlib+ -optimize+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose\Release\xamarinmac\Hprose.dll -define:dotNET4;dotNET45;MONO;Unity;ClientProfile -filealign:512 -target:library -noconfig -nowarn:1685 -nostdlib+ -optimize+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%

echo start compile hprose for Xamarin.Mac Debug
set DOTNET_PATH=%XAMARIN_PATH%\Xamarin.Mac\v2.0
set DOTNET_REFERENCE=
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\mscorlib.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Core.dll"
...
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Runtime.Serialization.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Numerics.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose.Client\Debug\xamarinmac\Hprose.Client.dll -define:dotNET4;dotNET45;MONO;Unity;ClientProfile;ClientOnly -filealign:512 -target:library -noconfig -nowarn:1685 -nostdlib+ -optimize+ -debug+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose\Debug\xamarinmac\Hprose.dll -define:dotNET4;dotNET45;MONO;Unity;ClientProfile -filealign:512 -target:library -noconfig -nowarn:1685 -nostdlib+ -optimize+ -debug+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%

echo start compile hprose for Xamarin.iOS Release
set DOTNET_PATH=%XAMARIN_PATH%\Xamarin.iOS\v1.0
set DOTNET_REFERENCE=
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\mscorlib.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Core.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Runtime.Serialization.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Numerics.dll"
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose.Client\Release\xamarinios\Hprose.Client.dll -define:dotNET4;dotNET45;MONO;Unity;Unity_iOS;ClientProfile;ClientOnly -filealign:512 -target:library -noconfig -nowarn:1685 -nostdlib+ -optimize+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
"%CSC%" -keyfile:HproseKeys.snk -out:dist\Hprose\Release\xamarinios\Hprose.dll -define:dotNET4;dotNET45;MONO;Unity;Unity_iOS;ClientProfile -filealign:512 -target:library -noconfig -nowarn:1685 -nostdlib+ -optimize+ %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
...
set DOTNET_PATH=%XAMARIN_PATH%\Xamarin.TVOS\v1.0
set DOTNET_REFERENCE=
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\mscorlib.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Core.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.dll"
...
set DOTNET_PATH=%XAMARIN_PATH%\Xamarin.WatchOS\v1.0
set DOTNET_REFERENCE=
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\mscorlib.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Core.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.dll"
