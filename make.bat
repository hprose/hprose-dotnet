...
if not exist dist\4.5.1\Core mkdir dist\4.5.1\Core
...
set WP80_PATH=C:\Program Files\Reference Assemblies\Microsoft\Framework\WindowsPhoneApp\v8.1
...
if DEFINED ProgramFiles(x86) set WP81_PATH=C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\WindowsPhoneApp\v8.1
...
C:\WINDOWS\Microsoft.NET\Framework\v1.0.3705\Csc.exe -out:dist\1.0\Hprose.Client.dll -define:dotNET10;ClientOnly -filealign:512 -target:library -optimize+ %1 %NUMERICS_SRC% %HPROSE_SRC% %HPROSE_INFO%
C:\WINDOWS\Microsoft.NET\Framework\v1.0.3705\Csc.exe -out:dist\1.0\Hprose.dll -define:dotNET10 -filealign:512 -target:library -optimize+ %1 %NUMERICS_SRC% %HPROSE_SRC% %HPROSE_INFO%

echo start compile hprose for .NET 1.1
c:\WINDOWS\Microsoft.NET\Framework\v1.1.4322\Csc.exe -out:dist\1.1\Hprose.Client.dll -define:dotNET11;ClientOnly -filealign:512 -target:library -optimize+ %1 %NUMERICS_SRC% %HPROSE_SRC% %HPROSE_INFO%
c:\WINDOWS\Microsoft.NET\Framework\v1.1.4322\Csc.exe -out:dist\1.1\Hprose.dll -define:dotNET11 -filealign:512 -target:library -optimize+ %1 %NUMERICS_SRC% %HPROSE_SRC% %HPROSE_INFO%
...
C:\WINDOWS\Microsoft.NET\Framework\v3.5\Csc.exe -keyfile:HproseKeys.snk -out:dist\3.5\ClientProfile\Hprose.Client.dll -define:dotNET35;ClientProfile;ClientOnly -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ %1 %DOTNET_REFERENCE% %NUMERICS_SRC% %HPROSE_SRC% %HPROSE_INFO%
...
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Runtime.Serialization.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Numerics.dll"
C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319\Csc.exe -keyfile:HproseKeys.snk -out:dist\4.0\ClientProfile\Hprose.Client.dll -define:dotNET4;ClientProfile;ClientOnly -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ %1 %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319\Csc.exe -keyfile:HproseKeys.snk -out:dist\4.0\ClientProfile\Hprose.dll -define:dotNET4;ClientProfile -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ %1 %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
...
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Runtime.Serialization.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Numerics.dll"
C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319\Csc.exe -keyfile:HproseKeys.snk -out:dist\4.5\Hprose.Client.dll -define:dotNET4;dotNET45;ClientOnly -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ %1 %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Web.dll"
C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319\Csc.exe -keyfile:HproseKeys.snk -out:dist\4.5\Hprose.dll -define:dotNET4;dotNET45 -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ %1 %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
...
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Runtime.Serialization.dll"
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Numerics.dll"
C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319\Csc.exe -keyfile:HproseKeys.snk -out:dist\4.5.1\Hprose.Client.dll -define:dotNET4;dotNET45;dotNET451;ClientOnly -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ %1 %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
set DOTNET_REFERENCE=%DOTNET_REFERENCE% -reference:"%DOTNET_PATH%\System.Web.dll"
C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319\Csc.exe -keyfile:HproseKeys.snk -out:dist\4.5.1\Hprose.dll -define:dotNET4;dotNET45;dotNET451 -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ %1 %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%

echo start compile hprose for .NET 4.5.1 Windows Store App
...
C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319\Csc.exe -keyfile:HproseKeys.snk -out:dist\4.5.1\Core\Hprose.Client.dll -define:dotNET4;dotNET45;dotNET451;Core;ClientOnly -filealign:512 -target:library -noconfig -nostdlib+ -optimize+ %1 %DOTNET_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
...
C:\WINDOWS\Microsoft.NET\Framework\v2.0.50727\Csc.exe -keyfile:HproseKeys.snk -out:dist\SilverLight2\Hprose.Client.dll -define:SILVERLIGHT;SL2;ClientOnly -filealign:512 -target:library -noconfig -nowarn:0444 -nostdlib+ -optimize+ %1 %SL_REFERENCE% %NUMERICS_SRC% %HPROSE_SRC% %HPROSE_INFO%
...
C:\WINDOWS\Microsoft.NET\Framework\v3.5\Csc.exe -keyfile:HproseKeys.snk -out:dist\SilverLight3\Hprose.Client.dll -define:SILVERLIGHT;SL3;ClientOnly -filealign:512 -target:library -noconfig -nowarn:0444 -nostdlib+ -optimize+ %1 %SL_REFERENCE% %NUMERICS_SRC% %HPROSE_SRC% %HPROSE_INFO%
...
C:\WINDOWS\Microsoft.NET\Framework\v3.5\Csc.exe -keyfile:HproseKeys.snk -out:dist\SilverLight4\Hprose.Client.dll -define:SILVERLIGHT;SL4;ClientOnly -filealign:512 -target:library -noconfig -nowarn:1685 -nostdlib+ -optimize+ %1 %SL_REFERENCE% %NUMERICS_SRC% %HPROSE_SRC% %HPROSE_INFO%
...
C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319\Csc.exe -keyfile:HproseKeys.snk -out:dist\SilverLight5\Hprose.Client.dll -define:SILVERLIGHT;SL5;ClientOnly -filealign:512 -target:library -noconfig -nowarn:1685 -nostdlib+ -optimize+ %1 %SL_REFERENCE% %NUMERICS_SRC% %HPROSE_SRC% %HPROSE_INFO%
...
C:\WINDOWS\Microsoft.NET\Framework\v3.5\Csc.exe -keyfile:HproseKeys.snk -out:dist\WindowsPhone\Hprose.Client.dll -define:WINDOWS_PHONE;WP70;ClientOnly -filealign:512 -target:library -noconfig -nowarn:0444 -nostdlib+ -optimize+ %1 %WP_REFERENCE% %NUMERICS_SRC% %HPROSE_SRC% %HPROSE_INFO%
...
C:\WINDOWS\Microsoft.NET\Framework\v3.5\Csc.exe -keyfile:HproseKeys.snk -out:dist\WindowsPhone71\Hprose.Client.dll -define:WINDOWS_PHONE;WP71;ClientOnly -filealign:512 -target:library -noconfig -nowarn:0444 -nostdlib+ -optimize+ %1 %WP_REFERENCE% %NUMERICS_SRC% %HPROSE_SRC% %HPROSE_INFO%
...
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Collections.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.IO.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Linq.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Net.Requests.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Net.Primitives.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Reflection.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Reflection.Extensions.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Reflection.Primitives.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Runtime.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Runtime.Extensions.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Runtime.Numerics.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Runtime.Serialization.Primitives.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Text.Encoding.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Text.Encoding.Extensions.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Threading.dll"
set WP_REFERENCE=%WP_REFERENCE% -reference:"%WP81_PATH%\System.Threading.Tasks.dll"
C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319\Csc.exe -keyfile:HproseKeys.snk -out:dist\WindowsPhone81\Hprose.Client.dll -define:dotNET4;dotNET45;dotNET451;Core;WP81;ClientOnly -filealign:512 -target:library -noconfig -nowarn:0444 -nostdlib+ -optimize+ %1 %WP_REFERENCE% %HPROSE_SRC% %HPROSE_INFO%
